...
## Render DB or PlanetScale

## Render

> https://dashboard.render.com/ > +New > PostgreSQL > Name and free > create

> scroll down > grab external DAtabase URL
> change .env variable to the new one, same with sata source in schema.prisma
> npx db push
